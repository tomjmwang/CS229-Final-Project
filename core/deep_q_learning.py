...
class DQN(QN):
    ...
    def add_summary(self):
        ...
        self.eval_wr_placeholder = tf.placeholder(tf.float32, shape=(), name="win_rate")
        ...
        self.wr_summary = tf.summary.scalar("Win_Rate", self.eval_wr_placeholder)
    ...
    def update_step(self, t, replay_buffer, lr):
        ...
        s_batch, a_batch, r_batch, sp_batch, done_mask_batch, next_action_mask_batch = replay_buffer.sample(
        ...
        fd = {
            ...
            self.next_action_mask: next_action_mask_batch,
            self.lr: lr, 
            # extra info
    ...
    def plot_wr(self, t):
        ...
        fd = {
            self.eval_wr_placeholder: self.eval_wr
        }

        summary = self.sess.run(self.wr_summary, feed_dict=fd)
